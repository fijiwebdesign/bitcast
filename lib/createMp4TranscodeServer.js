...
function createMp4TranscodeServer(torrent, { host, port }, fn) {
  ...
  app.get('/video', function (req, res) {
    ...
    const sendStream = progress => {
      // Transcoded output size is unknown up-front. Fall back to source file
      // length which, while not exact after re-encoding, is a reasonable
      // estimate that lets DLNA clients issue Range requests.
